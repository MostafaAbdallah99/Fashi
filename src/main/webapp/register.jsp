                ...
                <div class="register-form">
                    ...
                    <form action="register" method="post" onsubmit="return validateForm()">
                        <div class="group-input">
                            ...
                            <span id="usernameav" class="error"></span>
                        ...
                        <div class="group-input">
                            ...
                            <span id="emailav" class="error"></span>
                        ...
                        <div class="group-input">
                            <select id="country" name="country" class="form-control" style="height: 56px;">
                        ...
                        <div class="group-input">
                            ...
                            <div class="error-message" id="cardLimitError"></div>
                        </div>
                        <div class="group-input">
